...
/* ---------------------------------------------------------------------------------- */
/*  OpenCart admin/index.php (with modififications for the override feature)          */
/*                                                                                    */
/*  Original file Copyright © 2013 by Daniel Kerr (www.opencart.com)                  */
...
$registry->set('play', $factory->newPlay($registry));
$registry->set('ebay', $factory->newEbay($registry));
$registry->set('amazon', $factory->newAmazon($registry));
$registry->set('amazonus', $factory->newAmazonus($registry));
